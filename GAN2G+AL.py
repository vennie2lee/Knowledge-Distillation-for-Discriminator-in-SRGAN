...
from train import Train_and_Distill_only_gen
...
#train_only_gen
gan_trainer = Train_and_Distill_only_gen(generator=gan_generator, discriminator=discriminator(), teacher=teacher_gan_generator)
gan_trainer.train(train_ds, steps=1000)
gan_trainer.generator.save_weights(weights_file('gen1_gan_generator.h5'))

#Demo
gan_generator = st_generator()
gan_generator.load_weights(weights_file('gen1_gan_generator.h5'))
