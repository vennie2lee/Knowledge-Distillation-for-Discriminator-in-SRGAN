...
from train import KD_SrganTrainer
...
#train 
gan_trainer = KD_SrganTrainer(generator=gan_generator, discriminator=discriminator(), teacher=teacher_gan_generator, sr_discriminator=discriminator())
gan_trainer.train(train_ds, steps=1000)
gan_trainer.generator.save_weights(weights_file('kd_gan_generator.h5'))

#Demo
gan_generator = st_generator()
gan_generator.load_weights(weights_file('kd_gan_generator.h5'))
